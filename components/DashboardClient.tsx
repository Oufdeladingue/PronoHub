      ...
      <nav className="theme-nav">
        <div className="max-w-7xl mx-auto px-4 py-4 flex justify-between items-center">
          ...
          <div className="flex items-center gap-4">
            ...
            <Link
              href="/profile"
              className="px-4 py-2 text-sm theme-text hover:opacity-70 transition"
            >
              Profil
            </Link>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className={`theme-card ${hasReachedLimit ? 'opacity-60' : ''}`}>
            ...
            {hasReachedLimit ? (
              ...
              <a href="/join-tournament" className="flex items-center justify-center gap-2 w-full py-2 px-4 bg-[#ff9900] text-[#111] rounded-md hover:bg-[#e68a00] transition font-semibold">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 419.5 375.3" className="w-5 h-5" fill="currentColor">
