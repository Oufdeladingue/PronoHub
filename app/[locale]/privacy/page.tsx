      ...
      <div className="flex-1 bg-gradient-to-b from-gray-900 to-gray-800 text-white py-16 px-4">
        ...
        <div className="prose prose-invert prose-orange max-w-none space-y-8">
          ...
          <section>
            ...
            <ul className="list-disc list-inside text-gray-300 mt-2 space-y-1">
              <ListItems items={t.raw('s3.items') as ListItem[]} />
            </ul>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc list-inside text-gray-300 mt-2 space-y-1">
              <ListItems items={t.raw('s5.items') as ListItem[]} />
            </ul>
            <p className="text-gray-300 leading-relaxed mt-4">
              {t.rich('s5.noAds', bold)}
            </p>
            <div className="bg-gray-800 rounded-lg p-4 mt-4">
              <p className="text-sm text-gray-400">
                {t.rich('s5.management', bold)}
              </p>
            </div>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc list-inside text-gray-300 mt-2 space-y-1">
              <ListItems items={t.raw('s6.items') as ListItem[]} />
            </ul>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-300 leading-relaxed mt-4">
              {t.rich('s7.exercise', { contact: contactLink })}
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc list-inside text-gray-300 mt-2 space-y-1">
              <ListItems items={t.raw('s8.items') as ListItem[]} />
            </ul>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-300 leading-relaxed">
              {t.rich('s9.intro', bold)}
            </p>
            <ul className="list-disc list-inside text-gray-300 mt-2 space-y-1">
              <ListItems items={t.raw('s9.items') as ListItem[]} />
            </ul>
            <p className="text-gray-300 leading-relaxed mt-4">
              {t('s9.outro')}
            </p>
          ...
          <section>
            ...
            <p className="text-gray-300 leading-relaxed">
              {t.rich('s12.body', { contact: contactLink })}
            </p>
            <p className="text-gray-300 leading-relaxed mt-4">
              {t('s12.cnil')}
            </p>
