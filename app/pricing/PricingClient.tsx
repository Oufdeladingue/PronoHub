        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
          ...
          <div className="bg-gray-800/50 rounded-2xl p-6 border border-gray-700 flex flex-col">
            <div className="mb-6 text-center">
              <div className="w-12 h-12 bg-gray-700 rounded-full flex items-center justify-center mb-4 mx-auto">
            ...
            <ul className="space-y-3 mb-8 flex-grow">
              <PlanFeature included>Jusqu'à {ACCOUNT_LIMITS.free.maxTournaments} tournois</PlanFeature>
              ...
              <PlanFeature included>Règles bonus</PlanFeature>
              <PlanFeature>Statistiques avancées</PlanFeature>
          ...
          <div className="bg-gray-800/50 rounded-2xl p-6 border border-gray-700 flex flex-col">
            ...
            <ul className="space-y-3 mb-8 flex-grow">
              ...
              <PlanFeature>Tournois illimités</PlanFeature>
            </ul>
          ...
          <div className="bg-gradient-to-b from-orange-500/20 to-transparent rounded-2xl p-6 border-2 border-orange-500 flex flex-col relative">
            ...
            <div className="mb-6 text-center">
              ...
              <h3 className="text-xl font-bold mb-2">Joueur-clé</h3>
              <p className="text-gray-400 text-sm">Pour les passionnés</p>
            </div>
            ...
            <ul className="space-y-3 mb-8 flex-grow">
              <PlanFeature included>Jusqu'à {ACCOUNT_LIMITS.premium.maxActiveTournaments} tournois actifs</PlanFeature>
              ...
              <PlanFeature included>Statistiques complètes</PlanFeature>
              <PlanFeature included>Historique complet</PlanFeature>
              <PlanFeature included>Gestion avancée</PlanFeature>
              <PlanFeature included>Règles bonus paramétrables</PlanFeature>
              <PlanFeature included>Gestion des handicaps</PlanFeature>
            </ul>
          ...
          <div className="bg-gray-800/50 rounded-2xl p-6 border border-gray-700 flex flex-col">
            ...
            <ul className="space-y-3 mb-8 flex-grow">
              <PlanFeature included>Jusqu'à {ACCOUNT_LIMITS.enterprise.maxPlayersPerTournament} participants</PlanFeature>
              <PlanFeature included>Branding personnalisé</PlanFeature>
              ...
              <PlanFeature included>Classement individuel et en équipe</PlanFeature>
              <PlanFeature included>Valorisation des lots à pourvoir</PlanFeature>
            </ul>
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-4">
            ...
            <FaqItem
              ...
              answer="Oui, vous pouvez annuler à tout moment depuis votre espace client. Votre abonnement restera actif jusqu'à la fin de la période payée."
            />
          </div>
        </div>
      </div>
